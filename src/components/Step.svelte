...
<a
  href={step.href}
  target="_blank"
  class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-violet-700 text-center group hover:border-violet-400 duration-200 hover:scale-110"
>
  <div
  ...
  <h3 class="font-medium text-xl sm:text-2xl md:text-3xl pb-8">
    {step.name}
  </h3>
  <slot />
  <div class="flex-1 flex justify-betweeen gap-4 items-end">
    ...
    <div class="ml-auto">
      ...
      <p class="z-4">{step.bottom_description}</p>
    </div>
  </div>
</a>
